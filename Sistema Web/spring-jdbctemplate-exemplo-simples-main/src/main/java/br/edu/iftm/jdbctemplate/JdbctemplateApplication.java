...
public class JdbctemplateApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		jdbcTemplate.update("INSERT INTO contatos(nome,telefone) VALUES (?,?)", "Júlia Almeida", "123");
		jdbcTemplate.update("INSERT INTO contatos(nome,telefone) VALUES (?,?)", "Gerson Filho", "123");
		...
		System.out.println("O número de registros da tabela contatos é " + rowCount);
		String tel = this.jdbcTemplate.queryForObject(
				"select telefone from contatos where nome = ?",
				String.class, "Edson Angoti Júnior");
		System.out.println("O telefone  é " + tel);
	}
